...
<body>
    ...
    <div class="container_16">
        <div class="grid_16" id="productStrip">
            <div class="grid_16">
                <h1 class="bold underlined center" style="font-size:35px; margin:20px auto;" >Voeg product toe</h1>
            </div>
            <div class="grid_10 push_3">
                <form method="GET" action="addProduct">
                    <div class="grid_10">
                        <div class="grid_9">
                            <p style="font-size:15px;">Begin met het invoeren van het productinformatie stap voor stap</p>
                            <table class="stepTable">
                                <tr>
                                    <td colspan="2"><h1>Stap 1. Vul filiaal in</h1></td>
                                </tr>
                                <%//Retrieves The Data From company table%>
                                <tr>
                                    <td><h4>Selecteer een filiaal</h4> <br/> <h3 class="center">Or</h3><br/></td>
                            ...
                            <table class="stepTable">
                                <tr>
                                    <td colspan="2"><h1>Stap 2. Selecteer Categorie</h1></td>
                                </tr>
                                <%//Retrieves The Data From category table%>
                                <tr>
                                    <td><h4>Selecteer een categorie</h4> <br/> 
                                ...
                                <tr>
                                    <td><h4>Voeg categorie toe</h4></td>
                                    <td>
                                ...
                                <tr>
                                    <td><h4>Selecteer een sub-categorie</h4> <br/> <h3 class="center">Or</h3><br/></td>
                                    <td>
                                ...
                                <tr>
                                    <td><h4>Voeh sub-categorie toe</h4></td>
                        ...
                        <div class="clear"></div>
                        <h1>Stap 3. Vul productprijs in</h1>
                        <input type="text" name= "price" tabindex="1" placeholder="eg.Rs 7899/-"/><br/>
                        <br/>
                        <h1>Stap 4. Vul productnaam &AMP; aantal in</h1>
                        ...
                        <br/>
                        <h1>Stap 5. Vul producttags en productomschrijving in</h1>
                        <input id="tags" type="text" name= "tags" placeholder="Write in tags here without commas"/><br/>
                        <br/>  
                        <h1>Omschrijving van het product</h1>
...
<div class="container_16">
    <div class="grid_16" id="productStrip"> <a href="http:google.com">
            <div class="ProductHeading">
                <div class="grid_12">
                    <h2 class="heading">Meest bekeken producten</h2>
                </div>
                <div id="viewMore" class="grid_3">
                    <h6 class="blue">Zie meer</h6>
                </div>
            </div>
        </a>
        <div class="clear"></div>
...
<div id = "footer">
    <div class="container_16">
        ...
        <div id="clear"/>
        <div class="grid_16">	
            <p>Copyright &copy; 2016 Wesley de Gooijer - IPASS HU</p>
        </div>
    </div>
</div>
