...
/*
                        ...
                        <div class="grid_14">
                            ...
                            <div class="grid_3">
                                <p><%=sub_category_name %> <br/> <a href="admin_manageProduct.jsp?pid=<%= product_id %>" id="greenBtn">Wijzig</a><a style="margin-right: 10px;" href="addtoOrder.jsp?id=<%= product_id %>" id="greenBtn">Bestel</a>
                            </div>
                        </div>
                        <div class="clear"></div>
                        <%
