    ...
    <div class="container_16">
        <div class="grid_16">
            ...
            <div class="grid_6" id="top">
                <ul>
                    <a href="#" id="join"><li id="greenBtn"  class ="Btn showForm">Meld je nu aan!</li></a>
                </ul>
            </div>
        </div>
    </div>
                ...
                <form autocomplete="false" method="post" action="loginServlet"  name="login">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <label><input type="email" name="email" placeholder="voorbeeld@voorbeeld.com" required/><br/></label>
                            </td>
                        </tr>
                        <tr>
                            <td>
            ...
            <div class="grid_6 push_2" id = "RegisterForm">
                <form autocomplete="false" method="POST" action="register" name="registerServlet">
                    <table>
                        <tr>
                            <td colspan="2">
                                <strong><h1 style="font-wieght:bold; text-align:right; padding:20px 0px; color:#FFF;">Registreer</h1></strong>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <label><input type="email" name="emailReg" placeholder="voorbeeld@voorbeeld.com" required/><br/></label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="submit" value="Registreer" id="greenBtn" /><br/>
                            </td>
                        </tr>
                    </table>
