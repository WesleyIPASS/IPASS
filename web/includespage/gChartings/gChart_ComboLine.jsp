...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
        ...
        <div class="container_16">
            <div class="grid_16" style="padding: 10px;" id="whiteBox">
                <br/>
                <h1 class="grid_15" style="text-align: center;">Maandelijkse activiteiten grafiek - Uitgaven, Verkoop, Winst  </h1><br><br><hr/>
                ...
                <div class="grid_7">
                    <input class="grid_4" type="submit" id="buy" value="Ververs">
                </div>
                </form></div>
                <div class="clear"></div>
                  ...
                  <%
                        ...
                        if (month == 12){
                            monthInWords = "December";
                                ...
                                out.print("([ "
                                          + "['Dag', 'In afwachting', 'Goedgekeurd', 'Geleverd', 'Betaald' ], ");
                                int i = 0 ;
                                 while (i<= soldOn.size()-1){
                                      if (i< soldOn.size()-1){
                                         out.println(
                      ...
                      %>
                      var options = {
                                title: 'Activiteiten in de maand <%= monthInWords +" "+year %>',
                                  vAxis: {title: "Verkoop in euro's"},
                                  hAxis: {title: "Dagen van <%= monthInWords %>"}
                              };
