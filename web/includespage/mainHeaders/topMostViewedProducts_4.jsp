...
<div class="grid_13" id="productStrip"> 
    <a href="viewproducts.jsp">
        <div class="ProductHeading">
            <div class="grid_12">
                <h2 class="heading">Meest bekeken gerechten</h2>
            </div>
        </div>
    </a>
    <div class="clear"></div>
 ...
 while (rs.next()){ 
    ...
    <div id="productList" class="grid_3 prodGrid"> 
        ...
        <p id="info">
            ...
            Door <%= company %> <%= category %><br/>
            <span class="red">&euro; <%= price %></span>
        </p>            
    </div>
    <% if (i%4 == 0){ %>
    <div class="clear"></div>
    ...
    <div class="clear"></div><div id="productList" class="grid_3 prodGrid"> 
        <a href="product.jsp"><img src="images/linen.png" /></a>
        <p id="info">
            <a href="product.jsp?id="><span class="blue">Geen gerecht toegevoegd</span></a><br/>
            <br/>
