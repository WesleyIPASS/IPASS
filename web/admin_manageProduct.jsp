    ...
    <jsp:include page="includesPage/navigationbar.jsp"></jsp:include>
        ...
        <div class="container_16">
            <div class="grid_16" style="padding: 10px;" id="whiteBox">
                ...
                <br/>
                <h1 class="grid_15">Beheer productinformatie</h1><hr/>
...
%>
            <div id="middle"class="grid_13">
                 <div class="grid_13" id="whiteBox">
                    ...
                    <div class="ProductHeading">
                        <div class="grid_12">
                            <h1 class="grid_8">
                                    Kies een product om die te <span class="blue">bewerken</span>
                                </h1>
                            ...
                            <div class="grid_2">
                                <select id="sortBy" style="margin:  -2px; width: 240px;">
                                    <option value="qa">Sorteer op Voorraad laag naar hoog</option>
                                    <option  value="qd">Sorteer op Voorraad hoog naar laag</option>
                                    <option value="pa">Sorteer op Prijs laag naar hoog</option>
                                    <option  value="pd">Sorteer op Price hoog naar laag</option>
                                    <option  value="ha">Sorteer op Bekeken Laag naar hoog</option>
                                    <option  value="hd">Sorteer op Bekeken hoog naar laag</option>
                                </select>
                            </div>
                        </div>
        ...
        <div class="grid_2">
            ...
            <div class="grid_6">
                <p id="info"><a href="admin_manageProduct.jsp?pid=<%=product_id%>"><h3><span class="blue"> <%=product_name%></span></h3></a>Door <%= company_name + "'s " + category_name%><br/><span class="red">&euro; <%= price%></span></p>
                <p style="display: inline; color: #000">Bekeken: <span class="blue"><%= hits %></span></p>
                
            </div>
            <div class="grid_4">
                <p><%=sub_category_name%></p>
                <div class="grid_3" style="display: inline;">
                    <h1 style="display: inline; margin-left: -226px;">Aantal op voorraad: <%= qty %></h1> <a href="admin_manageProduct.jsp?pid=<%= product_id%>" id="greenBtn" style="display: inline;">Wijzig Product</a> 
                </div>
                <p>Aantal</p>
            </div>
        </div>
        ...
        <div class="grid_13"  style="padding: 10px 0px 10px 0px;" id="whiteBox">
            ...
            <form method="post" action="admin_changeProductInfo.jsp">
                ...
                <div class="grid_5">
                    <a href="admin_deleteProduct.jsp?pid=<%= productId%>" id="greenBtn">[x] Verwijder dit product</a>
                </div><!--
                <div class="grid_5">
                ...
                <div class="grid_13"  style="padding: 10px; ">
                    ...
                    <div class="clear"></div>
                    <div class="grid_2">
                        Voeg product aantal toe
                    </div>
                    <div class="grid_5">
                        <input type="text" name="addaantal" value="0" style="width: 75px;"/>
                    </div>
                    <div class="clear"></div><br/>
                    <div class="grid_2">
                        Product Prijs: &euro;
        ...
        <div class="grid_16" id="whiteBox">
            <br/>
            <h1 class="grid_7">Product afbeeldingen galerij <span class="red">Klik om te verwijderen</span></h1>
            <div class="grid_5">
                <a href="productInsertImages.jsp?pid=<%= productId%>" id="greenBtn"> [+] Voeg productafbeeldingen toe voor dit product</a>
