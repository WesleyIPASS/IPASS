...
/*
                        ...
                        <div class="grid_14">
                            <div class="grid_10">
                                <p id="info"><a href="product.jsp?id=<%=product_id%>"><h3><span class="blue"> <%=product_name %></span></h3></a>By <%= company_name+" "+ category_name %><br/><span class="red">&euro; <%= price %></span></p>
                            </div>
                            <div class="grid_3">
