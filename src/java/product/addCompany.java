    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (companyName.equals("")){
            ...
            try {
                ...
                String sqlInsertCompany = "INSERT INTO  `ipass`.`company` (`company-id` ,`company-name`)VALUES (NULL ,  '"+companyName+"');";  
                //String sqlInsertProduct = "INSERT INTO  `ipass`.`category` (`category_id` ,`category_name`)VALUES (NULL ,  '"+companyName+"'); ";
