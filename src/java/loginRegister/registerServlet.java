                ...
                if (isEmailValid) {
                    if (pass.length() > 7) {
                        if (pass.equals(passAgain)) {
                            ...
                            String sql = "INSERT INTO  `ipass`.`user` "
                            ...
                            out.print(" No Success!  both passwords do not match!");
                        ...
                        out.print(" No Success!! the password length is less than 7 character");
                    }
                } //or email is wrong
                else {
                    isRegistered = false;
                    ...
                    out.print(" No Success!! email is wrong");
                }
            }
            else {
                isRegistered = false;
